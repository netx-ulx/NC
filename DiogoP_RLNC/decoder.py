...
coefficient_matrix = genericmatrix.GenericMatrix((3,3),add=XOR,mul=AND,sub=XOR,div=DIV)
...
def handle_pkt(pkt):
        if P4RLNC in pkt:
            ...
            if packets_received == 3:
                ...
                original_symbols_matrix = genericmatrix.GenericMatrix((3,2),add=XOR,mul=AND,sub=XOR,div=DIV)
