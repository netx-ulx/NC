...
def parse_args():
    ...
    parser.add_argument("-c_flag", action="store", dest="c_flag", default=8, help="Flag that tells if coding is on or off")
...
def get_sender_args():
    ...
    type, gen_size, number_of_symbols, number_of_packets, field_size, pps = parse_config_file()
    return type, gen_size, number_of_symbols, number_of_packets, field_size, pps

def get_decoder_args():
    """ Returns the parameters needed for the decoder application in the config file """
    _,gen_size, number_of_symbols, number_of_packets, field_size, pps = parse_config_file()
    return gen_size, number_of_symbols, field_size, number_of_packets, pps
